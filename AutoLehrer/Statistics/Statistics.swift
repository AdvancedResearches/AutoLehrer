...
struct StatisticsView: View {
    ...
    func defaultTimeLearningData() {
        ...
        averageValue = TimeStatistics.auslesen_WeeklyAverageExam(in: viewContext, forThe: nil)
        if let averageValue = averageValue{
        ...
        for dieArt in alleWortArten{
            ...
            let averageValue = TimeStatistics.auslesen_WeeklyAverageExam(in: viewContext, forThe: dieArt)
            if let averageValue = averageValue{
                examTableItem.average = averageValue
            }
            examTableData.append(examTableItem)
